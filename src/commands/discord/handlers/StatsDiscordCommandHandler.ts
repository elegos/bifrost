...
export default class StatsDiscordCommandHandler extends DiscordCommandHandler {
    ...
    public async handleCommand(
        ...
        const inviteValue = `[Fluxer](${generateFluxerBotInviteLink(FLUXER_APP_ID, perms, FLUXER_BASE_URL ? new URL(FLUXER_BASE_URL).origin : undefined)}) | [Discord](${generateDiscordBotInviteLink(DISCORD_APP_ID, perms)})`;
